...
?>
	...
	<div class="<?=$prefix?>status-wwrapper">
		<ul>
			<li>
				<a data-stats="3" class="<?=$prefix?>statuscheck" href="javascript:void(0);">все <span data-max-summ="<?=$CountAll['DbSumm']?>" id="all-numb-summ" style="font-size:10px;"><?if($CountAll['DbSumm']){?>(<?=$CountAll['DbSumm']?>)<?}?></span></a>
			</li>
			<li>
			...
			<li>
				<a data-stats="1" class="<?=$prefix?>statuscheck <?=$prefix?>activeShowElPage" href="javascript:void(0);">активные <span data-max-summ="<?=$CountActive['DbSumm']?>" id="active-numb-summ" style="font-size:10px;"><?if($CountActive['DbSumm']){?>(<?=$CountActive['DbSumm']?>)<?}?></span></a>
			</li>
		...
		<select name="stats-staff" id="stats-staff" style="display:none;">
			...
			<option value="1" selected="selected">активные</option>
