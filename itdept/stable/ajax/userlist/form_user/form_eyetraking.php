	...
	<div class="right-staff-part">	
		...
		<table border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse;" class="tbl-staff">
			<tr>
				...
				<td><div class="staff-fontf staff-second-row font-wght"><?=$arRezlt['post_name']?></div></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td>
					<?if($arRezlt['staff_active'] == '0' AND $arRezlt['staff_datedeactive'] == '0000-00-00 00:00:00' AND $arRezlt['staff_typedeactive']=='' AND $userLevel['oper_correct_staff']=='1'){?><a onclick="actstaff(<?=$arRezlt['staff_id']?>,<?=$arRezlt['staff_profile_infoline']?>);" class="greenbtn" href="javascript:void(0);">Активировать</a><?}?>
				</td>
			</tr>
		</table>
	</div>
