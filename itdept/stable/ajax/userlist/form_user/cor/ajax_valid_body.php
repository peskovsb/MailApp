...
if(strlen($_POST['staff_cor_lastname'])>0){
	if(preg_match("/[^АБВГДЕЁЖЗИЙКЛМНОПРСТУФХЦЧШЩЪЫЬЭЮЯабвгдеёжзийклмнопрстуфхцчшщъыьэюя\-\_]+/", $_POST['staff_cor_lastname'])){
...
if(strlen($_POST['staff_name'])>0){
	if(preg_match("/[^АБВГДЕЁЖЗИЙКЛМНОПРСТУФХЦЧШЩЪЫЬЭЮЯабвгдеёжзийклмнопрстуфхцчшщъыьэюя\-\_]/", $_POST['staff_name'])){
...
if(strlen($_POST['staff_secondname'])>0){
	if(preg_match("/[^АБВГДЕЁЖЗИЙКЛМНОПРСТУФХЦЧШЩЪЫЬЭЮЯабвгдеёжзийклмнопрстуфхцчшщъыьэюя\-\_]/", $_POST['staff_secondname'])){
