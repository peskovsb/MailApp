...
<h1 class="form-header">Создать должность</h1>
					...
					<tr>
						...
						<td style="margin-bottom:8px;">
							<div style="margin-left:15px;">
								<input id="<?=$Items["name"]?>" class="field-tpl" type="text" name="<?=$Items["name"]?>">
							</div>	
						</td>
					</tr>
				<?}?>
					<tr>
						<td colspan="2">
							...
							<input style="margin-top:30px" class="btn green" type="submit" name="<?=$prefix?>_sendform" value="<?=$nameSender?>">
						</td>
					</tr>				
