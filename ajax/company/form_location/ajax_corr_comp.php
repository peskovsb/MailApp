...
$arrAll = $tb->fetch(PDO::FETCH_ASSOC);
	...
	$sql = 'SELECT * from itdeptlocation WHERE location_id=:id;';
...
<input name="dep_id" type="hidden" value="<?=$arrAll['location_id']?>">
	...
	<table>
		...
		<tr>
			<td class="field-cover">
				<label for="fld-altname-<?=$prefix_form?>-cor">Альтенативный заголовок</label>
			</td>
			<td>
				<input class="field-tpl" type="text" name="fld-altname-<?=$prefix_form?>-cor" id="fld-altname-<?=$prefix_form?>-cor" value="<?=$allDataInf['alternate_name']?>">
			</td>
		</tr>
		<tr>
			<td class="field-cover">
				<label for="fld-url-<?=$prefix_form?>-cor">Ссылка</label>
			</td>
			<td>
				<input class="field-tpl" type="text" name="fld-url-<?=$prefix_form?>-cor" id="fld-url-<?=$prefix_form?>-cor" value="<?=$allDataInf['location_url']?>">
			</td>
		</tr>
		<tr>
			<td class="field-cover">
				<label for="fld-sorting-<?=$prefix_form?>-cor">Сортировка</label>
			</td>
			<td>
				<input class="field-tpl" type="text" name="fld-sorting-<?=$prefix_form?>-cor" id="fld-sorting-<?=$prefix_form?>-cor" value="<?=$allDataInf['staff_locationssprting']?>">
			</td>
		</tr>
		
		<tr>
			<td class="field-cover">
				<label for="fld-infotext-<?=$prefix_form?>-cor">Информация</label>
			</td>
			<td>
				<textarea rows="8" class="field-tpl" type="text" name="fld-infotext-<?=$prefix_form?>-cor" id="fld-infotext-<?=$prefix_form?>-cor"><?=$allDataInf['location_info']?></textarea>
			</td>
		</tr>
