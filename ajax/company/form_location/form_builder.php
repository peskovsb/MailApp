...
<form class="formpadding" id="<?=$formName?>">
	<h1 class="form-header">Создать Локацию</h1>
	<table>
		...
		<?}?>
			<tr>
				<td class="field-cover">
					<label for="cr-loc-subnet">Подсеть</label>
				</td>
				<td style="position:relative;">
					<input class="field-tpl" type="text" name="cr-loc-subnet" id="cr-loc-subnet" value="">
					<i style="  margin-left: 10px;color: rgb(0, 153, 0);" class="fa fa-check-circle exelfiledIU"></i>
				</td>
			</tr>
			<tr>
				<td class="field-cover">
					<label for="cr-loc-url">Ссылка</label>
				</td>
				<td style="position:relative;">
					<input class="field-tpl" type="text" name="cr-loc-url" id="cr-loc-url" value="">
					<i style="  margin-left: 10px;color: rgb(0, 153, 0);" class="fa fa-check-circle exelfiledIU"></i>
				</td>
			</tr>
			<tr>
				<td class="field-cover">
					<label for="cr-loc-sorting">Сортировка</label>
				</td>
				<td style="position:relative;">
					<input class="field-tpl" type="text" name="cr-loc-sorting" id="cr-loc-sorting" value="500">
					<i style="  margin-left: 10px;color: rgb(0, 153, 0);" class="fa fa-check-circle exelfiledIU"></i>
				</td>
			</tr>
			<tr>
				<td class="field-cover">
					<label for="cr-loc-inform">Информация</label>
				</td>
				<td style="position:relative;">
					<textarea rows="8" class="field-tpl" type="text" name="cr-loc-inform" id="cr-loc-inform"></textarea>
					<i style="  margin-left: 10px;color: rgb(0, 153, 0);" class="fa fa-check-circle exelfiledIU"></i>
				</td>
			</tr>
		<tr class="btnarea">
			<td style="vertical-align: bottom;" colspan="2">
				<div style="margin: 20px auto 0;">
					...
					<input class="btn green" type="submit" name="<?=$prefix?>sendform" value="Создать Локация">
...
$(document).on('keypress','#cr-loc-subnet',function(e){
//console.log(hello);
  e = e || event;
