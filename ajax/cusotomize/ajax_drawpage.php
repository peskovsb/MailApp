	...
	<div class="IU-sidebar">
		<div class="sidebarinner">
			...
			<?//echo 'user level: '.$_SESSION['user_level'];?>
				<?if($_SESSION['user_level'] == '2'){?><a class="root-icon-iu-sidebarmenu IU-user-btn" href="javascript:void(0);">
				...
				<?if($_SESSION['user_level'] == '2'){?><a class="root-icon-iu-sidebarmenu IU-loging-btn IU-active" href="javascript:void(0);"><i class="fa fa-file-text"></i><span class="tooltip-css">Журнал</span></a><?}?>
				<?if($_SESSION['user_level'] == '2' || $_SESSION['user_level'] == '3'){?><a class="root-icon-iu-sidebarmenu IU-company-btn <?if($_SESSION['user_level']=='3'){?>IU-active<?}?>" href="javascript:void(0);"><i class="fa fa-home"></i><span class="tooltip-css">Компания</span></a><?}?>				
