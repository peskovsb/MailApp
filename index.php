...
timeoutID = setTimeout(sessiontimer,5000);
...
$('#clearTimeOut').click(function(){
	...
	$('.refreshersession-page').click(function(){
		location.reload()
	});
...
/*Unactive Script*/
  ...
  var no_active_delay = 420; // Количество секунд простоя мыши, при котором пользователь считается неактивным
...
<table class="tableMailAppRefresh" style="display:none;">
	<tr>
		<td class="refreshersession-page">
			<h2 style="font-family: Arial, sans-serif;font-size: 21px;margin: 0;">Время неактивности привышено</h2>
			<p style="font-family: Arial, sans-serif;font-size: 16px;margin: 3px 0;">Чтобы возобновить работу системы</p>
			<a style="font-family: Arial, sans-serif; font-size: 16px; display: inline-block; padding: 8px 15px; border: 4px solid #fff; margin-top: 16px;color:#fff;text-decoration:none;" href="javascript:void(0);" class="refreshersession-page">Перезагрузите страницу</a>
		</td>
	</tr>
</table>
<div id="topnav">
	<div class="vieport" style="margin-top:0;">
...
<div id="maiApplication">
	...
	<div class="menu-left-new-part"><a class="boxmailinner activeMenu" href="javascript:void(0)" style="position:relative;"><i style="  font-size: 16px;" class="fa fa-envelope"></i><span class="tooltip-css">Почта</span></a><?if($userLevel['oper_view_forw']==1){?><a class="aliasmlinner" href="javascript:void(0)" style="position:relative;"><i style="font-size:16px;" class="fa fa-exchange"></i><span class="tooltip-css">Переадресация</span></a><?}?></div>
	<!-- Search Form -->
	...
	<div class="menu-left-new-part"><a class="boxmailinner" style="position:relative;" href="javascript:void(0)"><i style="  font-size: 16px;" class="fa fa-envelope"></i><span class="tooltip-css">Почта</span></a><?if($userLevel['oper_view_forw']==1){?><a style="position:relative;" class="aliasmlinner" href="javascript:void(0)"><i style="font-size:16px;" class="fa fa-exchange"></i><span class="tooltip-css">Переадресация</span></a><?}?></div>
...
<div class="bottom-bottom-optionsAlias">
	<a class="a_BtnMassDelete" href="javascript:void(0);">Множественное удаление</a>
		...
		<link rel="stylesheet" href="css/exampletypehead.css">
</html>